...
- (void)reloadData{
    ...
    self.surroundLabel.text = [NSString stringWithFormat:@"围观人数：%d", self.siteModel.scanCount];
    self.favoritesLabel.text = [NSString stringWithFormat:@"收藏人数：%d", self.siteModel.collectCount];
}

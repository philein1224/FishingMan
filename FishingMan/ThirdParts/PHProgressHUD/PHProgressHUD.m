...
+(void)showSingleWheelInView:(UIView *)view{
    ...
    dispatch_time_t time=dispatch_time(DISPATCH_TIME_NOW, PHHUDTimeInterval*NSEC_PER_SEC);
...
+(void)showSingleMsgInBottom:(NSString *)msg view:(UIView *)view{
    ...
    [hud hideAnimated:YES afterDelay:PHHUDTimeInterval];
}
...
+ (void)showError:(NSString *)error toView:(UIView *)view{
    [self show:error icon:@"failed.png" view:view];
}

...
- (void)setup{
    ...
    _showDelete = YES;
    _showAddButton = YES;
    _allowRepeatedSelection = YES;
    _maxImageSelected = 30;
    _backgroundColor = [UIColor whiteColor];
    _isAddPresentVC = NO;
    rootVC = [self getTopController];//[self getCurrentVC];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //关闭键盘
    if(self.guestureRecognizedBlock){
        self.guestureRecognizedBlock();
    }

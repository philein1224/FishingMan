...
@interface EditFishSiteViewController ()<UITableViewDelegate,UIScrollViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"EditFishSiteTableViewCell" bundle:nil] forCellReuseIdentifier:@"EditFishSiteTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *CellIdentifier = @"EditFishSiteTableViewCell";
    EditFishSiteTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    if(!cell){
        cell = [[[NSBundle mainBundle] loadNibNamed:@"EditFishSiteTableViewCell" owner:nil options:nil] firstObject];
    }
    
    ZXH_WEAK_SELF
//    cell.moreMaterialShowOrHide = ^(BOOL isShow) {
//        if(isShow){
//            weakself.cellHeight = 714;
//        }
//        else{
//            weakself.cellHeight = 714-180;
//        }
//        
//        [weakself reloadCell];
//    };
...
- (IBAction)showSiteMoreInfoView:(id)sender {
    ...
    CLog(@"hhh %f", self.siteMoreInfoViewHeight.constant);
